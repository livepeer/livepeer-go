...
func (s *SDK) PostClip(ctx context.Context, request components.ClipPayload) (*operations.PostClipResponse, error) {
...
func (s *SDK) GetStreamIDClips(ctx context.Context, id string) (*operations.GetStreamIDClipsResponse, error) {
...
func (s *SDK) GetSessionIDClips(ctx context.Context, id string) (*operations.GetSessionIDClipsResponse, error) {
