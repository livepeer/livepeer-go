...
func (s *Webhook) Create(ctx context.Context, request components.WebhookInput) (*operations.CreateWebhookResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update a webhook
func (s *Webhook) Update(ctx context.Context, id string, webhook components.WebhookInput) (*operations.UpdateWebhookResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Webhook) GetLogs(ctx context.Context, id string) (*operations.GetWebhookLogsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Webhook) GetLog(ctx context.Context, id string, logID string) (*operations.GetWebhookLogResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Webhook) ResendLog(ctx context.Context, id string, logID string) (*operations.ResendWebhookResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
