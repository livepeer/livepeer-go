...
func newSigningKey(sdkConfig sdkConfiguration) *SigningKey {
	return &SigningKey{
...
func (s *SigningKey) Create(ctx context.Context) (*operations.CreateSigningKeyResponse, error) {
...
// Delete Signing Key
func (s *SigningKey) Delete(ctx context.Context, keyID string) (*operations.DeleteSigningKeyResponse, error) {
...
func (s *SigningKey) Get(ctx context.Context, keyID string) (*operations.GetSigningKeyResponse, error) {
...
func (s *SigningKey) Update(ctx context.Context, keyID string, requestBody operations.UpdateSigningKeyRequestBody) (*operations.UpdateSigningKeyResponse, error) {
