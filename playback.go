...
func newPlayback(rootSDK *Livepeer, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Playback {
	return &Playback{
		rootSDK:          rootSDK,
...
func (s *Playback) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetPlaybackInfoResponse, error) {
