...
func (s *AccessControl) Create(ctx context.Context) (*operations.CreateSigningKeyResponse, error) {
...
func (s *AccessControl) GetAll(ctx context.Context) (*operations.GetSigningKeysResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Delete Signing Key
func (s *AccessControl) Delete(ctx context.Context, keyID string) (*operations.DeleteSigningKeyResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *AccessControl) Get(ctx context.Context, keyID string) (*operations.GetSigningKeyResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *AccessControl) Update(ctx context.Context, keyID string, requestBody operations.UpdateSigningKeyRequestBody) (*operations.UpdateSigningKeyResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
